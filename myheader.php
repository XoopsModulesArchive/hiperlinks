...
// $Id: myheader.php,v 1.6 2005/03/25 11:08:22 buennagel Exp $
// ------------------------------------------------------------------------ //
...
$mail_body = rawurlencode(sprintf(_MD_INTLINKFOUND, $xoopsConfig['sitename']) . ': ' . XOOPS_URL . '/modules/hiperlinks/singlelink.php?cid=' . $cid . '&amp;lid=' . $lid);
?>
</head><body>
