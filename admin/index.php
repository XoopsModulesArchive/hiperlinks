...
function listNewLinks()
{
    ...
    $linkimg_array = XoopsLists::getImgListAsArray(XOOPS_ROOT_PATH . '/modules/hiperlinks/images/shots/');
...
. '<tr class="odd"><td>';
    ...
    if ($numrows > 0) {
        while (list($lid, $cid, $title, $address, $address2, $city, $state, $zip, $country, $phone, $fax, $email, $url, $logourl, $submitterid, $premium) = $xoopsDB->fetchRow($result)) {
            ...
            $shotdir = '<b>' . XOOPS_URL . '/modules/hiperlinks/images/shots/</b>';
...
<tr><td valign=top width=45%><small>" . _MD_SHOTIMAGE . '</small>';
            ...
            if ($xoopsModuleConfig['useshots'] && !empty($origlogourl)) {
                echo '<img src="' . XOOPS_URL . '/modules/hiperlinks/images/shots/' . $origlogourl . '" width="' . $xoopsModuleConfig['shotwidth'] . '">';
            } else {
                echo ' ';
            }
...
<tr><td valign=top width=45%><small>" . _MD_SHOTIMAGE . '</small>';
            ...
            if (1 == $xoopsModuleConfig['useshots'] && !empty($logourl)) {
                echo '<img src="' . XOOPS_URL . '/modules/hiperlinks/images/shots/' . $logourl . '" width="' . $xoopsModuleConfig['shotwidth'] . '" alt="/">';
            } else {
                echo ' ';
            }
