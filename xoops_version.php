...
// $Id: xoops_version.php,v 1.16 2005/03/30 01:51:59 mvandam Exp $
// ------------------------------------------------------------------------ //
...
$modversion['credits'] = 'Adam Frick<br>( http://www.FolsomLiving.com/ )<br>hiperlinks<br><br>Based on the MyLinks Module<br>By: Kazumi Ono<br>';
$modversion['help'] = 'xdir.html';
$modversion['license'] = 'GPL see LICENSE';
$modversion['official'] = 1;
$modversion['image'] = 'images/xdir_slogo.png';
$modversion['dirname'] = 'hiperlinks';
...
// Templates
$modversion['templates'][1]['file'] = 'xdir_brokenlink.html';
$modversion['templates'][1]['description'] = '';
$modversion['templates'][2]['file'] = 'xdir_link.html';
$modversion['templates'][2]['description'] = '';
$modversion['templates'][3]['file'] = 'xdir_index.html';
$modversion['templates'][3]['description'] = '';
$modversion['templates'][4]['file'] = 'xdir_modlink.html';
$modversion['templates'][4]['description'] = '';
$modversion['templates'][5]['file'] = 'xdir_ratelink.html';
$modversion['templates'][5]['description'] = '';
$modversion['templates'][6]['file'] = 'xdir_singlelink.html';
$modversion['templates'][6]['description'] = '';
$modversion['templates'][7]['file'] = 'xdir_submit.html';
$modversion['templates'][7]['description'] = '';
$modversion['templates'][8]['file'] = 'xdir_topten.html';
$modversion['templates'][8]['description'] = '';
$modversion['templates'][9]['file'] = 'xdir_viewcat.html';
$modversion['templates'][9]['description'] = '';
$modversion['templates'][10]['file'] = 'xdir_listingfull.html';
$modversion['templates'][10]['description'] = '';
$modversion['templates'][11]['file'] = 'xdir_premiumlink.html';
