...
// $Id: singlelink.php,v 1.10 2005/03/27 12:11:07 w4z004 Exp $
// ------------------------------------------------------------------------ //
...
$xoopsDB->queryF($sql);
$GLOBALS['xoopsOption']['template_main'] = 'xdir_singlelink.html';
