...
// $Id: notification.inc.php,v 1.2 2005/03/30 01:51:59 mvandam Exp $
// ------------------------------------------------------------------------ //
...
function xdir_notify_iteminfo($category, $item_id)
{
    ...
    if (empty($xoopsModule) || 'hiperlinks' != $xoopsModule->getVar('dirname')) {
        $moduleHandler = xoops_getHandler('module');

        $module = $moduleHandler->getByDirname('hiperlinks');
