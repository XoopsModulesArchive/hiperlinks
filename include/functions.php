...
// $Id: functions.php,v 1.8 2005/02/20 12:56:52 okazu Exp $
// ------------------------------------------------------------------------ //
...
function newlinkgraphic($time, $status)
{
    ...
    if ($startdate < $time) {
        if (1 == $status) {
            $new = '&nbsp;<img src="' . XOOPS_URL . '/modules/hiperlinks/images/newred.gif" alt="' . _MD_NEWTHISWEEK . '">';
        } elseif (2 == $status) {
            $new = '&nbsp;<img src="' . XOOPS_URL . '/modules/hiperlinks/images/update.gif" alt="' . _MD_UPTHISWEEK . '">';
        }
    }
...
function popgraphic($hits)
{
    ...
    if ($hits >= $xoopsModuleConfig['popular']) {
        return '&nbsp;<img src="' . XOOPS_URL . '/modules/hiperlinks/images/pop.gif" alt="' . _MD_POPULAR . '">';
    }
